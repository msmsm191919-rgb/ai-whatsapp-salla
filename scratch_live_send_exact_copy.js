...
(async () => {
    console.log('=== 🚀 EXACT ARABIC COPY DISPATCH TEST TO OWNER INBOX ===');
    ...
    try {
        ...
        // 3. QR Disconnected Preview with Exact Arabic Copy
