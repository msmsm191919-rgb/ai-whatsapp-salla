...
(async () => {
    console.log('=== 🚀 OFFICIAL LOGO EMAIL DISPATCH TEST TO OWNER INBOX ===');
    ...
    try {
        ...
        // 3. QR Disconnected Preview with Official Logo
